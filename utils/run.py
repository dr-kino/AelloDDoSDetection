...
class DDoSTopo(Topo):
    """ The mininet topology class for the P4 ddos project.
    """
...
class DDoSRunner:
    """
        Attributes:
            ...
            switch_json : string // json of the compiled p4
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
        ...
        """ Initializes some attributes and reads the topology json. Does not
            actually run the project. Use run_ddos() for that.

            Arguments:
                topo_file : string    // A json file which describes the projects's
                                         mininet topology.
                log_dir  : string     // Path to a directory for storing project logs
    ...
    def create_network(self):
        ...
        self.topo = DDoSTopo(self.hosts, self.switches, self.links, self.log_dir, self.bmv2_exe, self.pcap_dir)
...
if __name__ == '__main__':
    ...
    args = get_args()
    ddos = DDoSRunner(args.topo, args.log_dir, args.pcap_dir,
